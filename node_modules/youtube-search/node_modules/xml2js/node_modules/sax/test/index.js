let globalsBefore = JSON.stringify(Object.keys(global));
const util = require("util"), assert = require("assert"), fs = require("fs"), path = require("path"),
    sax = require("../lib/sax");
...
exports.test = function test (options) {
  const xml = options.xml, parser = sax.parser(options.strict, options.opt), expect = options.expect;
    let e = 0;
  sax.EVENTS.forEach(function (ev) {
    parser["on" + ev] = function (n) {
      ...
      const inspected = n instanceof Error ? "\n" + n.message : util.inspect(n);
  ...
  fs.readdir(__dirname, function (error, files) {
    ...
    files.forEach(function (file) {
      ...
      try {
        ...
        const globalsAfter = JSON.stringify(Object.keys(global));
